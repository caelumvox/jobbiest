...
public class OpportunityTableGateway {
    ...
    public List<Opportunity> getOpportunityList(int seekerId) {
        ...
        List<Map<String, Object>> resultList = jobbiestNamedParamJDBCTemplate.queryForList(opportunityListQuery,
                parameterMap);
    ...
    public Opportunity getOpportunity(int opportunityId) {
        ...
        Map<String, Object> resultMap = jobbiestNamedParamJDBCTemplate.queryForMap(opportunityQuery, parameterMap);
